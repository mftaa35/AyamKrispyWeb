...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!str_ends_with(strtolower($email), '@kurir.com')) {
        $error = "Hanya email dengan domain @kurir.com yang diizinkan.";
    } else {
        // Contoh login kurir (hardcoded atau bisa diganti dengan query DB)
        $kurirEmail = 'john@kurir.com';
        $kurirPassword = 'kurir123';

        if ($email === $kurirEmail && $password === $kurirPassword) {
        ...
        <div class="col-md-6">
          <div class="form-box">
            <div class="tab-header text-center">
              <button id="login-tab-btn" class="active">Login Kurir</button>
              <button id="signup-tab-btn">Signup Kurir</button>
            </div>

            <!-- Login Form -->
            <div id="login-tab" class="login-tab active-tab">
              <form action="kurirdashboard.php" method="post">
...
<div id="signup-tab" class="signup-tab">
  <form action="loginkurir.php" method="post">
    <input type="hidden" name="action" value="signup">
    <div class="form-group">
      <input type="email" name="email" class="form-control" placeholder="Email (@kurir.com)" required>
    </div>
    <div class="form-group">
      <input type="password" name="password" class="form-control" placeholder="Password" required>
    </div>
